...
/**
 * Controller to list the items in the Servicio model
 *
 * @author Luis Miguel Pérez Romero         <luismi@pcrednet.com>
 */
class ListServicio extends ListBusinessDocument
{
    ...
    {
        $this->createViewSales('ListServicio', 'Servicio', 'services');
        //$this->createViewLines('ListLineaServicio', 'LineaServicio');
    }
}
